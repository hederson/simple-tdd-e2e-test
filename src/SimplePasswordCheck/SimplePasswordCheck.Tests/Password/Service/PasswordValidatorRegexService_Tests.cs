...
{
    public class PasswordValidatorRegexService_Tests
    {
        PasswordValidatorRegexService passwordValidatorService;

        [SetUp]
        public void SetUp()
        {
            passwordValidatorService = new PasswordValidatorRegexService();
        }
